...
final class AuditLogContextPresenter
{
    ...
    public static function present(Activity $activity): array
    {
        ...
        return [
            ...
            'competition_type' => data_get($context, 'competition_type'),
            'category_id' => data_get($context, 'category_id'),
            'category_name' => data_get($context, 'category_name'),
            'season' => data_get($context, 'season'),
            'starts_at' => data_get($context, 'starts_at'),
            'ends_at' => data_get($context, 'ends_at'),
            'active' => data_get($context, 'active'),
            'copied_from_ranking_id' => data_get($context, 'copied_from_ranking_id'),
            'rules_copied_count' => data_get($context, 'rules_copied_count'),
