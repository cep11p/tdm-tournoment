...
const AUDIT_ACTIONS = [
  ...
  { value: 'game.created', label: 'Creación de partido' },
  { value: 'game.deleted', label: 'Eliminación de partido' },
  ...
  { value: 'ranking.created', label: 'Creación de ranking' },
  { value: 'ranking.updated', label: 'Actualización de ranking' },
  { value: 'ranking.activated', label: 'Activación de ranking' },
  { value: 'ranking.deactivated', label: 'Desactivación de ranking' },
  { value: 'ranking.deleted', label: 'Eliminación de ranking' },
